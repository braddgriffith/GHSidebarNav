...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
	if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])) {
		...
		UIView *topLine = [[UIView alloc] initWithFrame:CGRectMake(0.0f, -1.0f, [UIScreen mainScreen].bounds.size.height, 1.0f)];
...
//		topLine2.backgroundColor = [UIColor whiteColor];//[UIColor colorWithRed:(54.0f/255.0f) green:(61.0f/255.0f) blue:(77.0f/255.0f) alpha:1.0f];
//		[self.textLabel.superview addSubview:topLine2];
		...
		bottomLine.backgroundColor = [UIColor whiteColor];//[UIColor colorWithRed:(40.0f/255.0f) green:(47.0f/255.0f) blue:(61.0f/255.0f) alpha:1.0f];
